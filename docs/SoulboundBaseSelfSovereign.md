...
> Soulbound Base SBT Self Sovereign

Soulbound token that is the base for a SelfSovereing SBT to be deployed from SoulFactory

*Soulbound Base Self-Sovereing, that inherits from the SBT contract.*
